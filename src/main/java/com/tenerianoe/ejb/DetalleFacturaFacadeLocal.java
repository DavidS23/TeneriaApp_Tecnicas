...
public interface DetalleFacturaFacadeLocal {
    ...
    void insertarDetalleFacturaProcedimiento(DetalleFactura detalle, Factura factura, catalogo_producto producto);

    List<DetalleFactura> detallesFactura(Factura factura);

    void calcularTotalProcedimiento(Factura factura);
}
