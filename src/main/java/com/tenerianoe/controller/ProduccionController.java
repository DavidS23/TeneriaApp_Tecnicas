...
public class ProduccionController implements Serializable {
    ...
    public void init() {
        ...
        listaDetallesProduccionPorProceso = detalleProduccionEJB.listaDetallesPorProceso(produccion);
    }
    ...
    public void generarProcesoCuero() {
        ...
        try {
            ...
            for (InsumosPorcentaje item : listarPocentajesInsumos) {
                ...
                detalleProduccion.setTotalDetalle(BigDecimal.valueOf(cantidadProducto));
